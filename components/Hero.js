  ...
  return (
    ...
    <section className="relative flex items-center justify-center text-center min-h-[70vh] pb-16 pt-20">
      <div className="z-20 w-full">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center">
              ...
              <Image src="/images/setapp-icon-birthday-15.png" alt="setapp" width={128} height={128} />
            </div>
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <button className="w-11 h-11 bg-white flex items-center justify-center rounded-lg overflow-hidden hover:bg-gray-100 transition">
                <Image src="/images/app-store-badge.png" alt="apple" width={32} height={32} className="object-contain" />
              </button>
              <button className="w-11 h-11 bg-white flex items-center justify-center rounded-lg overflow-hidden hover:bg-gray-100 transition">
                <Image src="/images/google-play-badge.png" alt="google" width={32} height={32} className="object-contain" />
              </button>
            </div>
      ...
      <div className="absolute left-[8%] top-[15%] -rotate-10 z-[13]">
        <Image src="/images/pics-sticker.png" alt="pics" width={173} height={173} />
      </div>
      <div className="absolute left-[8%] top-[34%] rotate-3 z-[15]">
        <Image src="/images/group-sticker.png" alt="macpaw" width={58} height={58} />
      </div>
      <div className="absolute left-[15%] top-[32%] -rotate-6 z-[14]">
        <Image src="/images/pdf-sticker.png" alt="pdf" width={140} height={140} />
      </div>
      <div className="absolute left-[6%] top-[55%] -rotate-3 z-[11]">
        <Image src="/images/teamwork-sticker.png" alt="teamwork" width={226} height={123} />
      </div>
      <div className="absolute left-[6%] top-[68%] rotate-3 z-[12]">
        <Image src="/images/secure-sticker.png" alt="secure" width={175} height={176} />
      </div>

      {/* Right side stickers */}
      <div className="absolute right-[9%] top-[13%] rotate-10 z-[13]">
        <Image src="/images/wifi-sticker.png" alt="wifi" width={200} height={125} />
      </div>
      <div className="absolute right-[16%] top-[22%] -rotate-6 z-[14]">
        <Image src="/images/plan-sticker.png" alt="plan" width={169} height={169} />
      </div>
      <div className="absolute right-[7%] top-[38%] rotate-12 z-[15]">
        <Image src="/images/converter-sticker.png" alt="converter" width={155} height={153} />
      </div>
      <div className="absolute right-[11%] top-[53%] -rotate-7 z-[11]">
        <Image src="/images/manage-sticker.png" alt="manage" width={230} height={128} />
      </div>
      <div className="absolute right-[12%] top-[67%] rotate-9 z-[12]">
        <Image src="/images/code-sticker.png" alt="code" width={152} height={153} />
      </div>
    </section>
